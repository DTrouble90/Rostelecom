from Rostelecom.pages.registration_email import RegistrationEmail
from Rostelecom.pages.auth import *
from selenium.webdriver.common.by import By
from Rostelecom.pages.settings import fake_firstname, fake_lastname, fake_password
import time
import pytest
